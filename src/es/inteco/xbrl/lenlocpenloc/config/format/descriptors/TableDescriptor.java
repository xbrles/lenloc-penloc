 ...
 * TableDescriptor.java,v 1.4 2009/01/19 14:03:02 a130499 Exp $
 * 
 * 
 * 
 *<br>
...
public class TableDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
	...
	public TableDescriptor() {
		...
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(
		        es.inteco.xbrl.lenlocpenloc.config.format.Row.class, "_rowList", "row",
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler() {
			...
			public void setValue(java.lang.Object object, java.lang.Object value) throws IllegalStateException,
				...
				try {
					Table target = (Table) object;
					target.addRow((es.inteco.xbrl.lenlocpenloc.config.format.Row) value);
				} catch(java.lang.Exception ex) {
					throw new IllegalStateException(ex.toString());
				}
			}
			...
			@SuppressWarnings ("unused")
			public java.lang.Object newInstance(java.lang.Object parent) {
				return new es.inteco.xbrl.lenlocpenloc.config.format.Row();
			}
		};
		desc.setSchemaType("list");
		desc.setComponentType(es.inteco.xbrl.lenlocpenloc.config.format.Row.class.getName());
		desc.setHandler(handler);
		/* LENLOC : Cambiado */
	...
	public java.lang.Class getJavaClass() {
		return es.inteco.xbrl.lenlocpenloc.config.format.Table.class;
	}
