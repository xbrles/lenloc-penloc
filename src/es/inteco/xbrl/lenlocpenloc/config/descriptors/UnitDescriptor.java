...
public class UnitDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
	...
	public UnitDescriptor() {
		...
		// -- _key
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_key", "key",
		...
		// -- _code
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_code", "code",
		        org.exolab.castor.xml.NodeType.Attribute);
		desc.setImmutable(true);
		handler = new org.exolab.castor.xml.XMLFieldHandler() {
		...
		desc.setValidator(fieldValidator);
		// -- _prefix
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_prefix", "prefix",
		        org.exolab.castor.xml.NodeType.Attribute);
		desc.setImmutable(true);
		handler = new org.exolab.castor.xml.XMLFieldHandler() {
	...
	public java.lang.Class getJavaClass() {
		return es.inteco.xbrl.lenlocpenloc.config.Unit.class;
	}
